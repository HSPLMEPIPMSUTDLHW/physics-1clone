...
void draw()
{
    ...
    GuiSliderBar(Rectangle{ 60, 5, 1000, 10 }, "Angle", TextFormat("%.1f", launchAngle), &launchAngle, -PI, PI);
    GuiSliderBar(Rectangle{ 60, 20, 1000, 10 }, "X Pos", TextFormat("%.1f", X), &X, 0, InitialWidth);
    GuiSliderBar(Rectangle{ 60, 35, 1000, 10 }, "Y Pos", TextFormat("%.1f", Y), &Y, 0, InitialHeight);
    GuiSliderBar(Rectangle{ 60, 50, 1000, 10 }, "Speed", TextFormat("%.1f", launchSpeed), &launchSpeed, 0, 500);
